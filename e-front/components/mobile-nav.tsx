    ...
    return (
        <>
            <Button onClick={onOpen} className=" bg-transparent flex items-center gap-x-2 lg:hidden">
                ...
                <Menu className="lg:hidden" size={20} color="black"></Menu></Button>
            <Transition
                show={open}
                ...
                <Dialog className="relative z-40 lg:hidden" onClose={onClose}>
                    ...
                    <div className="fixed inset-0 z-40 flex">
                        <Dialog.Panel className="relative ml-auto flex h-full w-full max-w-xs flex-col overflow-y-auto bg-zinc-50 py-4 pb-6 shadow-xl">
